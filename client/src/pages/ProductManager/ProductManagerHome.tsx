...
export default function ProductManagerHome() {
  ...
  //   tasks.flatMap((t) => t.operators.map((op) => op._id))
  // );
  // const operatorsAssigned = operators.filter((op) =>
  //   assignedOperatorIds.has(op._id)
  // ).length;
  ...
  // const machinesInService = machines.filter(
  //   (m) => m.status === "en_service"
  // ).length;
  // const machinesStopped = machines.filter(
  //   (m) => m.status === "en_arret"
  // ).length;
  // const machinesMaintenance = machines.filter(
  //   (m) => m.status === "en_maintenance"
  // ).length;
  ...
  return (
    ...
    //     <OperatorsChart
    //       assigned={operatorsAssigned}
    //       unassigned={operatorsUnassigned}
    //     />
    //     <TasksStatusChart
